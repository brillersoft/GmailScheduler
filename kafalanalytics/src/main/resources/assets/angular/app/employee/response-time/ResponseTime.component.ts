...
var _templateURL =   'templates/employee/responseTime.component.html';

@Component({
  selector: 'app-root',
  templateUrl: _templateURL
})
export class ResponseTimeComponent implements OnInit,OnDestroy,AfterViewInit {
    ...
    private forth:boolean = false;
    private fifth:boolean = false;
