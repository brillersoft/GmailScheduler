        ...
        <div class="container-fluid">
             <div class="row">
                ...
                <div class="col-md-4 padding-left-4 padding-right-2">
                    <form method="post" action="app/noauth/forgotpassword">
                    <div class="background-color-ff width-70px height-70px border-radius-50 margin-left-40">
                        <img class="padding-5px width-70px height-70px" src="images/font-awesome.png">
                    </div>
                    <br>
                    <div class="form-row align-items-center padding-top-2">
                        <div class="col-12">
                          <label class="sr-only Ubuntu-L" for="inlineFormInput">Enter Email</label>
                          <input type="text" name="userLogin"  class="form-control mb-2 border-radius-20 height-35px Ubuntu-M" id="inlineFormInput1" placeholder="Enter Email for OTP Genrate" required="required">
                    ...
                    <div class="form-row align-item-center padding-top-2">
                        <div class="col-md-12">
                            <button type="submit" style="background-color: #941F5E" type="button" class="btn width-full border-radius-20 height-35px Ubuntu-L font-size-13 color-ff">Confirm</button>                            
                        </div>                        
                    </div>                                          
                   </form>
                </div>
